...
flags.DEFINE_string(
    'train_dir', None, 'Path to output model directory '
...
flags.DEFINE_string(
    ...
    'writing resulting metrics to `train_dir`.')
...
def main(unused_argv):
  ...
  config = tf.estimator.RunConfig('path where the training output files will be generated')
